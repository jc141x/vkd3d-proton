...
static void vkd3d_instance_deduce_config_flags_from_environment(void)
{
    ...
    if (getenv("VKD3D_SHADER_CACHE"))
    {
        INFO("VKD3D_SHADER_CACHE is used, shader_cache is enforced.\n");
        vkd3d_config_flags |= VKD3D_CONFIG_FLAG_SHADER_CACHE;
    }
...
static const struct vkd3d_debug_option vkd3d_config_options[] =
{
    ...
    {"shader_cache", VKD3D_CONFIG_FLAG_SHADER_CACHE},
